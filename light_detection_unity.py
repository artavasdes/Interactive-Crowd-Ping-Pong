...
"""
Unlike other version of this program, this one avoids the use of numpy due 
to the use of IronPython which sadly has no numpy support because of its .NET basis
"""
...
def bright_feed(capture, capturename):
    #bright setup
    print("Press S to save the bright image")
...
def dark_feed(capture, capturename):
    #dark setup
    print("Press S to save the dark image")
